...
public class RopeScript : MonoBehaviour {
	...
	==  Modified for manual length: Trevor Evans ==
	===============================================
	How To Use:
	 ( BASIC )
	...
	*/
	...
	//Joint Settings
	public Vector3 swingAxis = new Vector3(0,0,1);				 //  Sets which axis the character joint will swing on (1 axis is best for 2D, 2-3 axis is best for 3D (Default= 3 axis))
